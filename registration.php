...
<h2><b>REGISTRATION FORM</b></h2>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Choose Your Hostel</td>
					<Td>
					BH1<input value="BH1" type="checkbox" name="hob[]"/>
					BH2<input value="BH2" type="checkbox" name="hob[]"/>
                    BH3<input value="BH2" type="checkbox" name="hob[]"/>
					GH1<input value="GH1" type="checkbox" name="hob[]"/>
					</td>
				</tr>
